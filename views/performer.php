...
<html>
    <head>
        ...
        <script src="../js/app/performer.js"></script>
...
<?php
/* @var $movie MovieSeries */
?>
            <p class="subtitulo"><?php echo($movie->getOriginalTitle()); ?></p>                    
            <!-- NAVIGATION BAR -->
            <nav class="acciones">
                <p class="subtitulo">Actors/Directors List</p>

                <div id="acciones">
                    <div class="content pointer" id="NavNuevo" title="Nuevo" onClick="nuevo()"><span class="btnspan">nuevo</span></div>
                </div>
                <div class="clear"></div>
            </nav>
            <!-- RESULTS TABLE -->
        ...
        <section class="popup hidden" id="popUpDatos" >
            ...
            <section class="filtros">
                <form  id="formulario" action="#" method="POST" >
                    ...
                    <div class="div_row">
                        <div class="sombra">
                            <div class="placeholder">Person Id</div>
...
?>
                    ...
                    <input type="hidden" id="idMovie" name="idMovie" value="<?php echo($idMovie); ?>" />
